          ...
          <div id="contact">
            ...
            <div className="space-y-6">
              <p className="text-gray-600">
                Lorem ipsum dolor sit amet consectetur adipiscing elit. Habitant cursus eros ac convallis torquent donec ut accumsan. Donec eleifend tincidunt morbi urna porttitor lectus.
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Cairo Medical Center, 123 Medical St, Cairo, Egypt</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">contact@drdeepakmehta.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Cambria Road, Polo Alto, CA 94302, USA</p>
                  </div>
                </div>
              </div>
            </div>
